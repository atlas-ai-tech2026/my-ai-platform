...
export const SEED = [
  ...
  { ref: '101', owner: 'claude', status: 'in_progress', priority: 1,
    ...
    detail: '── THE PROBLEM, EXACTLY ── The picker listed 9 Kling models. Four ran on kie (3.0, 3.0 Turbo, 2.6, and Motion Control was NOT among them). Five ran on FAL: Kling 3.0 Omni (FAL kling v3 pro — a different product from kie\'s Kling O3), Kling 2.5 (FAL v1.5 pro), Kling 2.1 (FAL v2.1 standard), "Kling O1" (FAL\'s Kling 1.6 renamed — kie has no O1), both Motion Controls and both Edit models (FAL). No error ever showed: FAL answered, the charge landed, history said "Kling". '
  ...
  { ref: '105', owner: 'claude', status: 'in_progress', priority: 1,
    ...
    detail: 'WHERE THE ANSWER LIVES: every credit ever added is a ledger row (credits_history) with the email, the amount, the date, the admin who did it and the reason they typed. The Logs tab already filters those rows by reason text and by type, but shows 50 at a time and exports only the page on screen. '
  ...
  { ref: '104', owner: 'claude', status: 'in_progress', priority: 1,
