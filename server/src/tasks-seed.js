...
export const SEED = [
  ...
  { ref: '57', owner: 'owner', status: 'pending', priority: 1,
    ...
    detail: 'DONE 2026-08-19 in the same session: three access keys with FULL ACCESS TO EVERY BUCKET — 16 days old, one of them exposed in a screenshot — were replaced with scoped keys and deleted. Production verified re-hosting images AND video (992-1589ms) throughout. '
      ...
      + 'This does NOT break the build-before-delete rule. The replacement (voxel-prod-storage) is already live and proven; -2 is a leftover from a failed attempt, and removing it is the cleanup step of that rule, not an exception to it. '
