...
export const SEED = [
  ...
  { ref: '101', owner: 'claude', status: 'in_progress', priority: 1,
    ...
    detail: '── THE PROBLEM, EXACTLY ── The picker listed 9 Kling models. Four ran on kie (3.0, 3.0 Turbo, 2.6, and Motion Control was NOT among them). Five ran on FAL: Kling 3.0 Omni (FAL kling v3 pro — a different product from kie\'s Kling O3), Kling 2.5 (FAL v1.5 pro), Kling 2.1 (FAL v2.1 standard), "Kling O1" (FAL\'s Kling 1.6 renamed — kie has no O1), both Motion Controls and both Edit models (FAL). No error ever showed: FAL answered, the charge landed, history said "Kling". '
      ...
      + '── PRICES, BY THE CALCULATOR (cost ÷ 0.6 ÷ $0.063333, up to the next half credit) ── Motion Control was FLAT per clip (8/11 and 6/8) while kie bills PER SECOND of the reference clip (3–30 s): a 30-second Kling 3.0 clip at flat 11 would sell $0.70 of video that costs $1.80. Now per second: Kling 3.0 Motion Control 1.5 cr/s (720p) / 2 cr/s (1080p); Kling Motion Control 1 / 1.5 cr/s. Kling 2.1: 1 cr/s (kie\'s own line: 25 credits = $0.125 per 5 s; was 2 cr/s against a FAL basis). Kling 2.5: unchanged 1.2 cr/s (kie $0.042/s, 44.7%). Kling 3.0 Omni: unchanged 4 cr/s until kie\'s O3 price line is read. THE MOTION COST FIGURES ARE QUOTED, NOT READ FROM KIE\'S PAGE (3.0: 9 std / 12 pro kie credits per second; 2.6: 5 / 8) — kie\'s site is unreachable from the build container. Owner: open kie\'s Motion Control price line once and confirm or correct these two numbers. '
