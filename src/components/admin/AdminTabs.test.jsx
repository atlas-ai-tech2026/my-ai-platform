...
vi.mock('@/lib/adminApi', () => ({
  adminApi: {
    logs: vi.fn().mockResolvedValue({
      logs: [
        { id: 1, created_at: '2026-07-26T10:00:00Z', action: 'spend', amount: '-12.50', kie_credits: '90.00', reason: 'video: Kling 3.0', user_id: 7, email: 'user@example.com' },
        { id: 2, created_at: '2026-07-26T09:00:00Z', action: 'spend', amount: '-4.00', kie_credits: null, reason: 'image: Soul 2.0', user_id: 8, email: 'fal@example.com' },
        { id: 3, created_at: '2026-07-26T08:00:00Z', action: 'refund', amount: '12.50', kie_credits: null, reason: 'video failed', user_id: 7, email: 'user@example.com' },
      ],
      total: 3, limit: 50, offset: 0,
    }),
    usage: vi.fn().mockResolvedValue({
      daily: [{ day: '2026-07-26', voxel_spent: 16.5, voxel_refunded: 12.5, kie_credits: 90, generations: 2 }],
      models: [{ model: 'video: Kling 3.0', generations: 1, voxel_spent: 12.5, kie_credits: 90 }],
      totals: { voxel_spent: 16.5, voxel_refunded: 12.5, kie_credits: 90, generations: 2, active_users: 2 },
    }),
...
describe('LogsTab', () => {
  it('renders rows with voxel + KIE credit columns, and — for FAL rows', async () => {
    ...
    // kie-backed row shows its KIE credits, FAL row shows the dash
