...
export const communityFeed = [
  {
    id: 30, type: 'image', creator: 'voxel', views: '0', likes: '0', model: 'Nano Banana Pro',
    imageUrl: '/media/discover-dragon-castle.png',
    prompt: 'Cinematic wide shot of a weary medieval warrior standing in a Targaryen castle hall with dragon sigil tapestries, stone archways and gothic stained-glass windows, warm torchlight and god-rays, anamorphic flares, shot on ARRI Alexa 65 with Hawk65 Anamorphic 14mm at T1.8, ultra-detailed 4K'
  },
  {
    id: 31, type: 'image', creator: 'voxel', views: '0', likes: '0', model: 'Nano Banana Pro',
    imageUrl: '/media/discover-targaryen-guards.png',
    prompt: 'Cinematic wide shot of Targaryen royal guards in silver plate armor standing in formation outside a stone fortress at golden hour, holding tall banners with the three-headed dragon sigil, dramatic sunset god-rays slicing through the courtyard with intense anamorphic lens flares, weathered medieval castle walls and battlements in the background, knights with helmets and ceremonial flags, torches burning, epic dark fantasy atmosphere, shot on ARRI Alexa 65 with Hawk65 Anamorphic 14mm at T1.8, ultra-detailed 2K, aspect 16:9'
  },
