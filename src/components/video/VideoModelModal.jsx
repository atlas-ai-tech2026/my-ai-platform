...
const VIDEO_MODELS = [
  ...
  { id:'kling-3-turbo',  name:'Kling 3.0 Turbo',   brand:'Kling',     color:'#2563EB', badge:'FAST', desc:'Faster, cheaper Kling V3 tier — single continuous shot from your image', tags:['Start Frame','Fast'], res:'720-1080p', dur:'3-15s',  featured:true,  img:'https://images.unsplash.com/photo-1485846234645-a62644f84728?w=400&q=80&fit=crop' },
