...
const VIDEO_MODELS = [
  ...
  { id:'seedance-2-5',   name:'Seedance 2.5',      brand:'Seedance',  color:'#0D9488', badge:'NEW',  desc:'Up to 50 multimodal references, precise local editing and native audio',                 tags:['Reference','Audio','Editing'],    res:'480-1080p', dur:'4-15s',  featured:true,  img:'https://images.unsplash.com/photo-1518834107812-67b0b7c58434?w=400&q=80&fit=crop' },
  ...
  // ── FAL-backed (not available on kie.ai) ──
  { id:'kling-3-omni',   name:'Kling 3.0 Omni',    brand:'Kling',     color:'#2563EB', badge:null,   desc:'Enhanced multimodal references',              tags:['Reference','Multi-shots','Audio'], res:'720-1080p', dur:'3-15s',  img:'https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=400&q=80&fit=crop' },
